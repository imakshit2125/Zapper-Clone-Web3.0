...
//Finding NativeBalance from its Endpoint
app.get('/nativeBalance', async (req, res) => {

    await Moralis.start({apiKey: process.env.MORALIS_API_KEY});

    // getting response from nativeBalance API 
    try {
        // passing address and chain
        ...
        // for checking which type of token it is (eth or matic)
        let nativeCurrency;

        // ETH and MATIC respectively
        if (chain === "0x1") {
        ...
        //geting realtime token price in USD
